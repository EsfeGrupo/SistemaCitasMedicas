...
import org.example.persistencia.DoctorDAO; // Importa la interfaz o clase DoctorDAO, que define las operaciones de acceso a datos para la entidad doctor.
...
import org.example.dominio.Doctor; // Importa la clase User, que representa la entidad de usuario en el dominio de la aplicación.
...
public class DoctorForm extends JDialog {
    ...
    private DoctorDAO doctorDAO; // Instancia de DoctorDAO para realizar operaciones de base de datos de usuarios.
    ...
    public DoctorForm(MainForm mainForm) {
        ...
        doctorDAO = new DoctorDAO(); // Crea una nueva instancia de UserDAO al instanciar este formulario.
        ...
        btnCrear.addActionListener(s -> {
            ...
            DoctorWriteForm doctorWriteForm = new DoctorWriteForm(this.mainForm, CUD.CREATE, new Doctor());
            // Hace visible el formulario de escritura de usuario.
            doctorWriteForm.setVisible(true);
        ...
        btnEditar.addActionListener(s -> {
            ...
            Doctor doctor = getDoctorFromTableRow();
            ...
            if (doctor != null) {
                ...
                DoctorWriteForm doctorWriteForm = new DoctorWriteForm(this.mainForm, CUD.UPDATE, doctor);
                // Hace visible el formulario de escritura de usuario.
                doctorWriteForm.setVisible(true);
        ...
        btnEliminar.addActionListener(s -> {
            ...
            if (doctor != null) {
                ...
                DoctorWriteForm doctorWriteForm = new DoctorWriteForm(this.mainForm, CUD.DELETE, doctor);
                // Hace visible el formulario de escritura de usuario.
                doctorWriteForm.setVisible(true);
    ...
    public void createTable(ArrayList<Doctor> doctores) {
        ...
        for (int i = 0; i < doctores.size(); i++) {
            ...
            model.setValueAt(doctor.getStrDisponibilidad(), i, 4);
        }
    ...
    private Doctor getDoctorFromTableRow() {
        Doctor doctor = null; // Inicializa la variable user a null.
        try {
